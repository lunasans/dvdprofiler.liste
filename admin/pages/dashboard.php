        ...
        <div class="row align-items-center">
            <div class="col-md-8">
                ...
                <p class="dashboard-subtitle">
                    Willkommen im Admin Center von <?= htmlspecialchars(getSetting('site_title', 'DVD Profiler Liste')) ?>
                </p>
            </div>
            ...
            <div class="card dashboard-card mb-4">
                <div class="card-header">
                    <h5 class="mb-0">
                        ...
                        System-Status
                        <span class="badge bg-<?= $systemHealth['overall'] ? 'success' : 'danger' ?> ms-2">
                            <?= $systemHealth['overall'] ? 'Gesund' : 'Probleme' ?>
                        </span>
                    </h5>
                </div>
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-6">
                            <div class="health-item">
                                <i class="bi bi-database <?= $systemHealth['database'] ? 'text-success' : 'text-danger' ?>"></i>
                                <span>Datenbank: <strong><?= $systemHealth['database'] ? 'Verbunden' : 'Fehler' ?></strong></span>
                            </div>
                            <div class="health-item">
                                <i class="bi bi-code-slash <?= $systemHealth['php_version'] ? 'text-success' : 'text-warning' ?>"></i>
                        ...
                        <div class="col-md-6">
                            <div class="health-item">
                                ...
                                <span>Memory: <strong><?= formatBytes($systemHealth['memory_usage'] ?? 0) ?></strong></span>
                            </div>
                            <div class="health-item">
                                <i class="bi bi-hdd text-info"></i>
                                <span>Disk: <strong><?= formatBytes($systemHealth['disk_space'] ?? 0) ?> frei</strong></span>
                            </div>
                        </div>
                    </div>
                    
                    <?php if (!$systemHealth['overall']): ?>
            ...
            <div class="card dashboard-card mb-4">
                ...
                <div class="card-body">
                    ...
                    <div class="d-flex gap-2 mt-3">
                        ...
                        <a href="<?= DVDPROFILER_GITHUB_URL ?>/releases/latest" target="_blank" class="btn btn-outline-secondary">
                            ...
                            <?php foreach ($dashboardStats['popular_genres'] as $genre): ?>
                                <div class="genre-item">
                                    ...
                                    <div class="genre-stats">
                                        ...
                                        <div class="genre-bar">
                                            <div class="genre-progress" style="width: <?= ($genre['count'] / max(1, $dashboardStats['popular_genres'][0]['count'])) * 100 ?>%"></div>
                                        </div>
                                    </div>
                                </div>
                            <?php endforeach; ?>
            ...
            <div class="card dashboard-card mb-4">
                ...
                <div class="card-body">
                    <div class="system-info">
                        ...
                        <div class="info-item">
                            <strong>Features:</strong> <?= count(array_filter(DVDPROFILER_FEATURES)) ?>/<?= count(DVDPROFILER_FEATURES) ?> aktiv
                        </div>
                        <div class="info-item">

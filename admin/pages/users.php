                            ...
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center">
                                        <div class="avatar me-3">
                                            <div style="width: 40px; height: 40px; background: var(--clr-accent); border-radius: 50%; display: flex; align-items: center; justify-content: center; color: white; font-weight: bold;">
                                ...
                                <td>
                                    <div class="btn-group btn-group-sm">
                                        ...
                                        <?php if (!$user['twofa_enabled']): ?>
                                            <button class="btn btn-outline-success setup-2fa-btn"
                                                    data-id="<?= $user['id'] ?>"
                                        ...
                                        <?php else: ?>
                                            ...
                                            <button class="btn btn-outline-danger disable-2fa-btn"
                                                    data-id="<?= $user['id'] ?>"
            ...
            <div class="modal-body">
                ...
                <div id="setup-step-2" style="display: none;">
                    <div class="row">
                        <div class="col-md-6 text-center">
                            ...
                            <div class="mb-3">
                                <img id="qrcode-image" src="" alt="QR-Code" class="img-fluid" style="max-width: 200px; border: 1px solid var(--clr-border); border-radius: 8px;">
                            </div>
                            ...
                            <form id="verify2faSetupForm">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control text-center" 
                                           id="setup-token" name="token" required
                ...
                <div id="setup-step-3" style="display: none;">
                    <div class="text-center">
                        ...
                        <h6>Backup-Codes</h6>
                        <p class="text-muted">Speichern Sie diese Codes sicher. Sie können jeden Code nur einmal verwenden.</p>

...
<div class="container-fluid">
    ...
    <div class="card mb-4">
        ...
        <div class="card-body">
            <form action="<?= htmlspecialchars(BASE_URL) ?>/admin/actions/import-handler.php" 
                ...
                <div class="d-flex gap-2">
                    ...
                    <button type="button" class="btn btn-secondary" onclick="document.getElementById('xml_file').click()">
                        📁 Datei wählen
                    </button>
                </div>
            </form>
                            ...
                            <?php foreach ($files as $file): ?>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <br>
                                        <small class="text-muted text-uppercase"><?= htmlspecialchars($file['extension']) ?>-Datei</small>
                                    </td>
                                    ...
                                    <td>
                                        <div class="btn-group btn-group-sm">
                                            <a href="xml/<?= urlencode($file['name']) ?>" 
                                               target="_blank" 
